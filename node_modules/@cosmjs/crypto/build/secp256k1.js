...
class Secp256k1 {
    ...
    static compressPubkey(pubkey) {
        switch (pubkey.length) {
            case 33:
                return (0, encoding_1.fixUint8Array)(pubkey);
            case 65:
                return (0, encoding_1.fixUint8Array)(secp256k1_1.secp256k1.Point.fromBytes(pubkey).toBytes(true));
            default:
    ...
    static uncompressPubkey(pubkey) {
        switch (pubkey.length) {
            case 33:
                return (0, encoding_1.fixUint8Array)(secp256k1_1.secp256k1.Point.fromBytes(pubkey).toBytes(false));
            case 65:
                return (0, encoding_1.fixUint8Array)(pubkey);
            default:
                throw new Error("Invalid pubkey length");
    ...
    static trimRecoveryByte(signature) {
        switch (signature.length) {
            case 64:
                return (0, encoding_1.fixUint8Array)(signature);
            case 65:
